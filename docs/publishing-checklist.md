...
- Engineering-depth routing image: `assets/opc-develop-routing.png`
...
rg -q 'EXPLICIT ENGINEERING TRIGGER|明确工程触发器' assets/opc-develop-routing.svg assets/opc-develop-routing.zh-CN.svg
